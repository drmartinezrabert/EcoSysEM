...
class Environment:
    ...
    def getDHr(self, typeRxn, input_, specComp = False):
        ...
        Returns
        -------
        Results are saved as an attribute of model instances (modelName.DHr) as a dictionary.
        ...
        DHr_dict = {}
        DHr, infoRxn = ThSA.getDeltaHr(typeRxn, input_, phase, specComp = specComp, T = T)
