...
--------------------------------------------------------------------------
References: - Copernicus CAMS Website - https://atmosphere.copernicus.eu/
--------------------------------------------------------------------------
### Data organization
   - `cmly` folder: combined monthly data.
   - `dly` folder: daily data.
   - `mly` folder: monthly data.

**The folders are automatically created when data is downloaded or created.**